...
function Footer() {
   return (
      <footer className='bg-[#F1F1F1] py-16 min-h-[300px]'>
         <div className='grid grid-cols-2 gap-x-3 gap-y-5 lg:gap-x-0 lg:gap-y-0 lg:grid-cols-4 max-w-7xl m-auto p-5 xl:p-0'>
            <div className='lg:border-r-2 border-main-color lg:pt-5'>
               ...
               <div className=' text-slate-950 font-bold mb-10 lg:mb-0'>
                  <div className='text-sm'>grumpy.gr © 2024</div>
               </div>
            </div>
            <div className='flex flex-col text-slate-950 font-bold gap-4 mb-10 lg:mb-0 lg:items-center'>
               <div className='flex flex-col items-start'>
                  ...
                  <Link href='/cookies' className='pt-5 text-sm'>
                     Consent Manager
                  </Link>
                  <Link href='/terms' className='pt-5 text-sm'>
                     Terms
                  </Link>
                  <Link href='/privacy' className='pt-5 text-sm'>
                     Privacy
                  </Link>
               </div>
            </div>
            <div className='flex flex-col text-slate-950 font-bold gap-4 mb-10 lg:mb-0 lg:items-center'>
               <div className='flex flex-col items-start'>
                  ...
                  <Link href='/projects' className='pt-5 text-sm'>
                     Projects
                  </Link>
                  <Link href='/contact' className='pt-5 text-sm'>
                     Contact
                  </Link>
                  <Link href='/story' className='pt-5 text-sm'>
                     Story
                  </Link>
               </div>
            </div>
            <div className='mb-10 lg:mb-0 flex flex-col gap-4 lg:items-end'>
               <div className='flex flex-col items-start'>
                  ...
                  <a href='https://www.instagram.com/grumpy.gr/' target='_blank' className='pt-5'>
