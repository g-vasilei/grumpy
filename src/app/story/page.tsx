   ...
   return (
      <div className='px-5 xl:px-0 pt-36 pb-36 w-full max-w-7xl m-auto text-slate-950 font-medium tracking-wide'>
         <p className='mb-10'>
            ...
            own feelings of sadness and isolation.
         </p>
         <p className='mb-10'>
            Growing up, George faced challenges fitting in with his peers. His sensitivity and introverted nature made
            it difficult for him to connect in a way that felt genuine. But amidst this struggle, he discovered a kind
            of companionship in the music of Lil Peep. The lyrics seemed to articulate the emotions he couldn t express
            and provided a sense of validation for his own sadness.
         </p>
         <p className='mb-10'>
            As George journeyed through adolescence, the weight of his emotions grew heavier. He found himself turning
            more to music, using it as a canvas to paint the colors of his emotions. Inspired by Lil Peep s honesty,
